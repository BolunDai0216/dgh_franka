...
class ipc_trigger_t(object):
    """
    Class for communicating with the LCM sychronization messages from the DGM
    """
    ...
    def _get_packed_fingerprint():
        if ipc_trigger_t._packed_fingerprint is None:
            ipc_trigger_t._packed_fingerprint = struct.pack(
                ">Q", ipc_trigger_t._get_hash_recursive([])
            )
